    ...
    <div class="container">
        <div class="box">
            ...
            <form method="POST" id="form">
                ...
                <div class="input">
                    <input value="<?php if(isset($_COOKIE["user"])) { echo $_COOKIE["user"]; } ?>" type="text" name="user" placeholder="Usuário" id="user">
                    <small></small>
                </div>
                <div class="input">
                    <input value="<?php if(isset($_COOKIE["password"])) { echo $_COOKIE["password"]; } ?>" type="password" name="password" placeholder="Senha" id="password">
                    <small></small>
                    <span class="eye">
                ...
                <div class="cad">
                    <a>Ainda não tem uma conta? <a id="linkcad" href="cadastro.php">Cadastre-se.</a></a>
                </div>
            </form>
        </div>
    </div>
